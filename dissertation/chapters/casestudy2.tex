...
\begin{table}[h]
    ...
    \end{tabular}
    \caption{The maximum loss probability for player 1 in Liar's Dice in the 2-dice variant with each possible permutation of the safe and risky strategies.}
