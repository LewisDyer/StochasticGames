...
def lookup(fname):
    functions = {"comment": comment, "player": player, "score": score, "die": die, "dietoss": dietoss, "listcovers": list_covers, "listboards": list_boards, "board_given_score": board_given_score}
