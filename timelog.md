...
10/12/20 | 3 hours | State reduction method unsuccessful, need to find other ways to simplify model. Tried combining all die rolls into one step - this too was unsuccessful.
