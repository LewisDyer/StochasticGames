...
09/12/10 | 5 hours | Investigated long verification time for Liar's Dice - tried making smaller variants of models, altering grid resolution. Supervisor meeting + adding minutes. Came up with method to reduce state space, started creating preprocessing tools to permit this.
